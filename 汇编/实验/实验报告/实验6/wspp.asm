;TITLE WSPP ---Program of word process fubction
...
start:
				push 		ds 				;save for retuen to DOS 
				sub	 		ax,ax 
				push 		ax 
				...
				mov 		bufpt,0 
				mov 		rowmx,0 
				mov 		cx,length cntl 	;itinitialize cntl area 
				mov 		al,0 
				lea 		di,cntl 	
				cld
				rep			stosb
